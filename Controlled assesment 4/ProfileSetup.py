...
class ProfileSetup(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.BackButton= ttk.Button(self, text="Back",command=self.BackButtonRun)
        ...
        self.SubmitButton= ttk.Button(self, text="Submit",command=lambda: self.addNewPlayer(controller) )
        self.BackButton= ttk.Button(self, text="Back",command=lambda: controller.show_frame("Login"))
