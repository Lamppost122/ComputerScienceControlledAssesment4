...
class EditPlayer(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            self.StartCount = 3
            self.Title = ttk.Label(self,text = "Edit player details" ,font = controller.title_font)
            self.lblPlayer = ttk.Label(self,text = "Player: ")
            self.txtPlayer = ttk.Entry(self)
            self.getPlayerButton = ttk.Button(self,text = "Get Players",command = self.GetPlayers)
            self.EditPlayerButton = ttk.Button(self,text = "Edit Players",command = self.Edit_Players)
